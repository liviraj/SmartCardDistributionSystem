		...
		<center>
			...
			<div style="padding-left: 539px; padding-right: 539px;">
				<label>UserId</label> <input class="form-control" type="text"
					name="uname" placeholder="enter user name" required autofocus></input>
				<br>
				<label>Password</label> <input class="form-control" type="password"
					name="psw" placeholder="enter password" required></input> <br>
				<input class="btn-info" type="submit" value="submit" name="submit"></input>
				<a href="LoginHomeController?action=cancel"><button
						class="btn-danger">Cancel</button></a>
			</div>
		</center>
	</form>
</body>
